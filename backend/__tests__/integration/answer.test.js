...
//       const response = await request(app).get('/answers/home/1');
...
//       const response = await request(app).get('/answers/home/1');
//       console.log(response.body, 'helloully');
...
//       const response = await request(app).get('/answers/home/9999');
...
// commmented this out as the answer router has been commented out so it doesn't work